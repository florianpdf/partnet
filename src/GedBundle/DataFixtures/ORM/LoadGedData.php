...
class LoadGedData extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $document->setDateAjout(new \DateTime('08/15/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('08/30/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('07/10/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('09/07/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('10/16/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('08/20/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('08/23/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('07/27/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('09/04/2015'));
        $document->setFinDeVie(new \DateTime('06/01/2016'));
        $document->setFilActu('1');
        $manager->persist($document);
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('05/14/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('05/02/2015'));
        $document->setFinDeVie(new \DateTime('01/01/2017'));
        $document->setFilActu('1');
        $manager->persist($document);
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('08/09/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('08/18/2015'));
        ...
        $document->createFile("pdf");
        $document->setFileName('test_upload.pdf');
        $document->setDateAjout(new \DateTime('10/05/2015'));
